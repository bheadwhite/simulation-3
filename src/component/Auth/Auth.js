...
class Auth extends Component{
    ...
    register = () => {
        axios.post('http://localhost:3001/api/register', {username:this.props.username, password:this.props.password})
        .then(res => {
            if(res.data === 'exists'){
